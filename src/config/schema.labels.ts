...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.orchestrationTrace.enabled": "Orchestration Trace Enabled",
  "diagnostics.orchestrationTrace.filePath": "Orchestration Trace File Path",
  "diagnostics.orchestrationTrace.includeContext": "Orchestration Trace Include Context",
  "diagnostics.orchestrationTrace.includePolicyChecks": "Orchestration Trace Include Policy Checks",
  "agents.defaults.orchestration.enabled": "Orchestration Enabled",
  "agents.defaults.orchestration.router.enabled": "Orchestration Router Enabled",
  "agents.defaults.orchestration.router.model": "Orchestration Router Model",
  "agents.defaults.orchestration.router.timeoutMs": "Orchestration Router Timeout (ms)",
  "agents.defaults.orchestration.router.maxTokens": "Orchestration Router Max Tokens",
  "agents.defaults.orchestration.localFastPath.enabled": "Local Fast-Path Enabled",
  "agents.defaults.orchestration.localFastPath.model": "Local Fast-Path Model",
  "agents.defaults.orchestration.localFastPath.maxInputChars": "Local Fast-Path Max Input Chars",
  "agents.defaults.orchestration.localFastPath.requireFlowContext":
    "Local Fast-Path Requires Flow Context",
  "agents.defaults.orchestration.localFastPath.allowMedia": "Local Fast-Path Allow Media",
  "agents.defaults.orchestration.localFastPath.promptMode": "Local Fast-Path Prompt Mode",
